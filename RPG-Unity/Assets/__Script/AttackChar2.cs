...
public class AttackChar2 : MonoBehaviour
{
    ...
    IEnumerator Attack2()
    {
        ...
        arrowSprite1.transform.rotation = Quaternion.EulerAngles(0, 0, Mathf.Atan2(lastMoveDir.y, lastMoveDir.x) );
        
        // Middle Arrow Properties
        arrowSprite1.GetComponent<Rigidbody2D>().velocity = attack2Speed * lastMoveDir.normalized * Time.fixedDeltaTime;
        ...
        arrowSprite2.transform.rotation = Quaternion.EulerAngles(0, 0, Mathf.Atan2(lastMoveDir.y, lastMoveDir.x) + Mathf.PI/12);
        
        // Top Arrow Properties
        Vector2 arrow2Vector = new Vector2(
        ...
        arrowSprite2.GetComponent<Rigidbody2D>().velocity = attack2Speed * arrow2Vector.normalized * Time.fixedDeltaTime;
